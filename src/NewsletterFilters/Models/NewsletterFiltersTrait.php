...
trait NewsletterFiltersTrait
{
    ...
    {
        $this->belongsTo(
            NewsletterFilters::RELATION_NEWSLETTER,
    ...
    {
        return PackageConfig::tableName(NewsletterModels::NEWSLETTER_FILTERS, NewsletterFilters::TABLE);
    }
}
